SUBROUTINE read_geom_coord()
use nrtype ; use coordinates
implicit none

! This subroutine reads the "geom.xyz" QoMMMa coordinate file
...
do img_num=1,nimg
	...
	open(unit=8,file=("geom1.xyz"), position="rewind")
	read(unit=8,fmt=*) i
...
END SUBROUTINE read_geom_coord
