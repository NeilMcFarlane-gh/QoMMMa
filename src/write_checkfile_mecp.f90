SUBROUTINE write_checkfile_mecp()
...
write(unit=8,fmt='(A)') "This file contains info needed for execution of qommma_mecp.x"
...
write(unit=8,fmt='(A)') "Energy of state A at the previous step:"
write(unit=8,fmt='(F15.8)') ea
write(unit=8,fmt='(A)') "Energy of state B at the previous step:"
write(unit=8,fmt='(F15.8)') eb
...
END SUBROUTINE write_checkfile_mecp
